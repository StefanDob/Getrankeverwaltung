...
public class SupportView extends VerticalLayout {
    ...
    public SupportView() {
        ...
        Anchor pdfLink = new Anchor("/manual.pdf", "Download Instruction Manual");
        ...
        suggestionsTextArea.setPlaceholder("Enter your suggestions here...");
        ...
        Button submitButton = new Button("Submit", event -> {
            ...
            if (suggestion.isEmpty()) {
                Notification.show("Please enter a suggestion", 3000, Notification.Position.MIDDLE)
                        .addThemeVariants(NotificationVariant.LUMO_ERROR);
            } else {
                EmailOperations.sendSuggestionToAdmin(suggestion);
                Notification.show("Thank you for your suggestion!", 3000, Notification.Position.MIDDLE)
